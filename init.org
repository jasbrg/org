...
(set-face-attribute
 'default nil :family "Iosevka Custom" :height 150 :weight 'regular)

(set-face-attribute
 'fixed-pitch nil :family "Iosevka Custom" :height 150 :weight 'regular)

(set-face-attribute
 'variable-pitch nil :family "Iosevka Etoile" :height 140 :weight 'regular)
#+end_src
